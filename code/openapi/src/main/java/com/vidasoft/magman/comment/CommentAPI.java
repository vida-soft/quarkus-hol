...
public interface CommentAPI {
    ...
    Response getCommentById(@Parameter(example = "123") @NotNull @Positive @PathParam("id") Long articleId,
                            @Parameter(example = "235") @Positive @PathParam("commentId") Long commentId);
}
