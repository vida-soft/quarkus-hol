...
If your request's response is simple, you can directly set the return value, which will populate the response's body. But if you would like to return different types of responses, then you'll have to use `javax.ws.rs.Response` and create your custom responses.
